...
def parse_args():
    ...
    parser.add_argument("--filtered_train_data", type = str, default = None, help = "Path to train data csv/tsv file")
    parser.add_argument("--validation_data", type = str, default = None, help = "Path to validation data csv/tsv file")
    parser.add_argument("--eval_data_type", type = str, default = None)
    ...
    parser.add_argument("--eval_batch_size", type = int, default = 2048, help = "Batch size")
    parser.add_argument("--cross_lr", type = float, default = 5e-4, help = "Cross-modality Learning rate")
    parser.add_argument("--in_lr", type = float, default = 5e-4, help = "In-modality Learning rate")
    parser.add_argument("--filter_lr", type = float, default = 5e-6, help = "Filtering Learning rate")
    ...
    parser.add_argument("--representation", action = "store_true", default = False, help = "get the average cosine similarity of all image-caption pair throughout the training.")
    parser.add_argument("--memory_bank", action = "store_true", default = False, help = "activate memory bank")
    parser.add_argument("--memory_bank_size", type = int, default = 256, help = "memory bank size")
    parser.add_argument("--cross_aug", action = "store_false", default = True, help = "augmentation during the cross-modality epochs")
    parser.add_argument("--inmodal_warmup", type = int, default = 5, help = "number of epochs for inmodal pretraining")
    parser.add_argument("--cross_inmodal", action = "store_false", default = True, help = "inmodality training after warmup epochs")
    parser.add_argument("--multimodal_warmup", type = int, default = 1, help = "number of epochs for multimodal pretraining")
    parser.add_argument("--filter_ratio", type = float, default = 0.15, help = "the ratio of samples to keep")
    parser.add_argument("--loader_update_freq", type = int, default = 1, help = "number of epochs for multimodal pretraining")
    # parser.add_argument("--index_update_freq", type = int, default = 1, help = "update the existing indices")
    ...
    parser.add_argument("--update_filter_ratio", type = float, default = 0.01)
    # parser.add_argument("--save_index", action = "store_true", default = False)
    parser.add_argument("--index_dir", type = str, default = "indices")
    parser.add_argument("--cap_filter_ratio", type = float, default = 0.85)
